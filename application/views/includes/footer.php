...
<footer class="footer">
    <div class="footer-main">
        <div class="container">
            <div class="row items">
                <div class="col-xl-3 col-lg-3 col-md-4 col-12 item">
                    <!-- Begin company info -->
                ...
                <div class="col-xl-2 offset-xl-1 col-md-2 col-5 col-lg-2 item">
                ...
                <div class="col-xs-2 col-lg-2 col-md-2 col-4 item">
                    <div class="footer-item">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row justify-content-between items">
                ...
                <div class="col-md-auto col-12 item">
                    <div class="copyright">© 2019 Glass Dubai Aluminium. All rights reserved.</div>
                </div>
            </div>
        </div>
    </div>
...
<script async src="<?php echo base_url('assets/js/script.min.js')?>"></script>
</body>
</html>